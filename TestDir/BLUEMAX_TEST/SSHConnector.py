...
class SSHConnector():
    ...
    def ssh_connect(self, con_info, hostname, ip1_list, ha):
        ...
        for i in range(0, len(dev_list)):
            # dev_cfg = ['interface eth1\n', 'no ip add\n', 'ip add 100.100.100.100/24\n', 'exit\n', 'y\n']
            # dev_cfg[0] = f'interface {dev_list[i]}\n'
            # dev_cfg[2] = f'ip add {ip1_list[i][0]}/{ip1_list[i][1]}\n'
            # print(dev_cfg)
            if i == 3:
